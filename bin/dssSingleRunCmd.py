...
# Simulation Settings
@click.option('--start_day', default=286, type=click.INT, help='Start day for the simulation study')  # 156-163, 286-293
@click.option('--end_day', default=293, type=click.INT, help='End day for the simulation study')
...
@click.option('--dss_file', default='MasterCircuit_Mikilua_baseline2.dss', type=click.STRING,
