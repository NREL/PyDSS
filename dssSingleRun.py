...
@click.option('--end_day', default=5, type=click.INT, help='End day for the simulation study')
...
@click.option('--active_scenario', default='Rural', type=click.STRING, help='Project scenario to use')
@click.option('--dss_file', default='MasterCircuit_Mikilua_baseline2_ESS_Rural.dss', type=click.STRING, help='The main OpenDSS file')
# Logger settings
