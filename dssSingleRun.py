...
@click.option('--export_style',default='Seperate_files', type=click.STRING, help='possible options "Single_file" and "Seperate_files"')
# Plot Settings
...
@click.option('--step_resolution_min', default=1, type=click.FLOAT, help='Time step resolutiom in minutes')
...
@click.option('--active_project', default='Sumitomo-Validation', type=click.STRING, help='Name of project to run')
@click.option('--active_scenario', default='ESS-CF', type=click.STRING, help='Project scenario to use')
@click.option('--dss_file', default='MasterCircuit_C591.dss', type=click.STRING, help='The main OpenDSS file')
# Logger settings
